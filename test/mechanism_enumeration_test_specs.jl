...
function build_multi_reg_stage_expansion_specs()
    ...
    # Base: 5 forms, 5 edges (4 RE binding + 1 SS isomerization)
    # Allosteric expansion runs (orchestrator defaults catalytic_n=1)
    let
        base = EnzymeRates._catalytic_topologies(
